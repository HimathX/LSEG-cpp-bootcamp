...
struct ParseReject {
    ...
    std::string reason = "Missing fields";
...
private:
    ...
    Order pasrseOrder(const std::vector<std::string>& fields, std::uint64_t seqNum); // Convert a vector of strings into an Order object
